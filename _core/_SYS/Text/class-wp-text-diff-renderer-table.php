...
class WP_Text_Diff_Renderer_Table extends Text_Diff_Renderer {
	...
	public function addedLine( $line ) {
		return "<td class='diff-addedline'><span aria-hidden='true' class='fa fa-plus'></span><span class='screen-reader-text'>" . 'Added:' . " </span>{$line}</td>";
	...
	public function deletedLine( $line ) {
		return "<td class='diff-deletedline'><span aria-hidden='true' class='fa fa-minus'></span><span class='screen-reader-text'>" . 'Deleted:' . " </span>{$line}</td>";
	}
